      ...
      <div class="auth-box">
        ...
        <form @submit.prevent="handleRegister" class="auth-form">
          <div class="form-group">
            ...
            <input v-model="form.fullName" type="text" placeholder="Nhập họ và tên của bạn" required />
          </div>
...
/* CẬP NHẬT: Thay đổi hình nền thành ảnh trang sức cao cấp */
.auth-banner {
  flex: 1;
  position: relative;
  /* Thay URL này bằng ảnh trang sức thật của bạn hoặc ảnh stock chất lượng cao */
...
/* Giữ nguyên lớp overlay gradient đỏ mận/đen để làm nổi logo và slogan */
.banner-overlay {
  position: absolute;
  top: 0;
  left: 0;
