  ...
  <div class="email-campaign-edit pb-5">
    <div class="container-fluid py-4">
      ...
      <div class="row g-4" v-if="isLoading">
        <div class="col-xl-12">
          <div class="card border-0 shadow-sm form-card h-100 placeholder-glow">
            <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
              <h6 class="fw-bold mb-0 text-brand">Sửa đổi cấu hình</h6>
            </div>
            <div class="card-body p-4">
              <div class="mb-4 bg-light p-3 rounded-3 border border-light d-flex gap-2">
                <span class="placeholder col-2 rounded-pill bg-secondary opacity-25" style="height: 32px;"></span>
                <span class="placeholder col-3 rounded-pill bg-secondary opacity-25" style="height: 32px;"></span>
                <span class="placeholder col-2 rounded-pill bg-secondary opacity-25" style="height: 32px;"></span>
              </div>
              <div class="row g-3 mb-4">
                <div class="col-md-7"><span class="placeholder col-12 rounded bg-secondary opacity-25" style="height: 58px;"></span></div>
                <div class="col-md-5"><span class="placeholder col-12 rounded bg-secondary opacity-25" style="height: 58px;"></span></div>
              </div>
              <div class="mb-4">
                <span class="placeholder col-12 rounded bg-secondary opacity-25" style="height: 58px;"></span>
              </div>
              <div class="mb-3">
                <span class="placeholder col-12 rounded bg-secondary opacity-25" style="height: 250px;"></span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card border-0 shadow-sm form-card h-100">
            ...
            <div class="card-body p-4">
              <form @submit.prevent="updateHoliday">
                ...
                <div class="mb-3">
                  <label class="form-label fw-semibold small text-muted text-uppercase mb-2">Đối tượng nhận <span class="text-danger">*</span> <span class="text-lowercase fw-normal">(có thể chọn nhiều)</span></label>
                ...
                <div class="form-floating mb-3">
                  <input v-model.trim="holidayForm.subject" type="text" id="holidaySubject" class="form-control bg-light border-0" placeholder="Tiêu đề email" required>
...
// Đồng bộ checkbox mục tiêu y hệt Edit.vue cũ
