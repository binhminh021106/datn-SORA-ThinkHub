              ...
              <div class="card-body p-4 bg-light">
                ...
                <div class="mb-4">
                  ...
                  <div class="input-group shadow-sm">
                    <input type="text" class="form-control fw-bold text-dark fs-5 text-end" v-model="displayDiscountValue" required placeholder="0">
...
const submitCombo = () => {
  ...
  const proceedSubmit = () => {
    ...
    else formData.append('usage_limit', ''); 
