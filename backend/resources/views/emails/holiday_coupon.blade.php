  ...
  <div style="padding: 20px;">
    ...
    <div style="background: #fff0f3; border: 1px dashed #dc3545; padding: 16px; border-radius: 8px; margin-bottom: 10px;">
      ...
      <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
        ...
        <tr><td style="color: #6c757d; padding: 4px 0;">Áp dụng:</td><td style="text-align: right; color: #212529;">Tất cả bộ sưu tập</td></tr>
        <tr><td style="color: #6c757d; padding: 4px 0;">Hạn sử dụng:</td><td style="text-align: right; color: #212529;">30/05/2026</td></tr>
      </table>
    </div>
    @endif
