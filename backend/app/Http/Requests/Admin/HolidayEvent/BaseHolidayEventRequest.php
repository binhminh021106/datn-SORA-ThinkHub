...
abstract class BaseHolidayEventRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'discount_value.integer' => 'Mức giảm giá phải là một số nguyên.',
            'discount_value.min' => 'Mức giảm giá không được nhỏ hơn 0.',
            'min_spend.integer' => 'Chi tiêu tối thiểu phải là số nguyên.',
        ];
    }
}
